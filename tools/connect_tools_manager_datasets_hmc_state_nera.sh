...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE UTILS - MANAGER DATASETS - HMC - STATE - REALTIME NERA'
...
folder_datasets_gridded_source='/hydro/archive/model_dset_state_nera/gridded/'
folder_datasets_gridded_destination='/hydro/archive/model_dset_restart_nera/gridded/'

folder_datasets_point_source='/hydro/archive/model_dset_state_nera/point/'
folder_datasets_point_destination='/hydro/archive/model_dset_restart_nera/point/'
