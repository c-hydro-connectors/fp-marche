...
#-----------------------------------------------------------------------------------------
# Script information
script_name='HYDE UTILS - MANAGER DATASETS - HMC - STATE - REALTIME MARCHE'
...
folder_datasets_gridded_source='/hydro/archive/model_dset_state_marche/gridded/'
folder_datasets_gridded_destination='/hydro/archive/model_dset_restart_marche/gridded/'

folder_datasets_point_source='/hydro/archive/model_dset_state_marche/point/'
folder_datasets_point_destination='/hydro/archive/model_dset_restart_marche/point/'
...
if [ ! -d "$folder_datasets_gridded_destination" ]; then
	mkdir -p $folder_datasets_gridded_destination
fi
...
if [ ! -d "$folder_datasets_point_destination" ]; then
	mkdir -p $folder_datasets_point_destination
fi
