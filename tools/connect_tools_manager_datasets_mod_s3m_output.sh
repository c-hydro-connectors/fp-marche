...
# ----------------------------------------------------------------------------------------
# Script information
script_name='HYDE UTILS - MANAGER DATASETS - MOD - S3M OUTPUT - REALTIME'
script_version="1.0."
...
# Script argument(s)
data_folder_remote_raw="/home/regmarche/fp-s3m-Marche/%YYYY/%MM/%DD/"
data_folder_local_raw="/hydro/data/data_dynamic/source/s3m/%YYYY/%MM/%DD/"
